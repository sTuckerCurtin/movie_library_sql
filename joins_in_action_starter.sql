...
-- select * from movies 
-- left join  users on movie_id = users.user_id
...
-- select* from movies
-- right join users on movies.movie_id = users.user_id
...
-- select * from movies
-- inner join users on movies.movie_id = users.favorite_movie_id;
...
-- inner join users on users.favorite_movie_id = movies.movie_id
